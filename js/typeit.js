...
!function (e, t) {
    ...
    "use strict";
    const e = e => Array.isArray(e), t = t => e(t) ? t : [t];
    const s = "data-typeit-id", i = "ti-cursor", r = {started: !1, completed: !1, frozen: !1, destroyed: !1}, n = {
            breakLines: !0,
            cursor: {
                autoPause: !0,
                autoPauseDelay: 500,
        ...
        a = e => document.createElement(e), u = e => document.createTextNode(e), l = (e, t = "") => {
            let s = a("style");
            s.id = t, s.appendChild(u(e)), document.head.appendChild(s)
        }, h = t => (e(t) || (t = [t / 2, t / 2]), t), d = (e, t) => Math.abs(Math.random() * (e + t - (e - t)) + (e - t));
    let p = e => e / 2;
    ...
    function y(e, t = !1, s = !1) {
        let r, n = e.querySelector(`.${i}`), o = document.createTreeWalker(e, NodeFilter.SHOW_ALL, {
            acceptNode: e => {
                if (n && s) {
    ...
    const b = e => Number.isInteger(e), P = ({queueItems: e, selector: t, cursorPosition: s, to: i}) => {
        if (b(t)) return -1 * t;
        let r = new RegExp("END", "i").test(i), n = t ? [...e].reverse().findIndex((({char: e}) => {
            let s = e.parentElement, i = s.matches(t);
    ...
    let v = e => new Promise((t => {
        ...
        }, I = e => e.func?.call(null), q = async ({index: e, queueItems: t, wait: s, cursor: i, cursorOptions: r}) => {
            let n = t[e][1], o = [], a = e, u = n, l = () => u && !u.delay, h = n.shouldPauseCursor() && r.autoPause;
            for (; l();) o.push(u), l() && a++, u = t[a] ? t[a][1] : null;
            if (o.length) return await v((async () => {
                for (let e of o) await I(e)
            })), a - 1;
            let d, p = T(i);
            return p && (d = {...p.effect.getComputedTiming(), delay: h ? r.autoPauseDelay : 0}), await s((async () => {
                p && h && p.cancel(), await v((() => {
                    I(n)
                }))
            }), n.delay), await (({cursor: e, options: t, cursorOptions: s}) => {
                if (!e || !s) return;
                let i, r = T(e);
                r && (t.delay = r.effect.getComputedTiming().delay, i = r.currentTime, r.cancel());
                let n = w({cursor: e, frames: s.animation.frames, options: t});
                return i && (n.currentTime = i), n
            })({cursor: i, options: d, cursorOptions: r}), e
        };
    ...
    return class {
        ...
        constructor(e, s = {}) {
            var i;
            this.opts = E(n, s), this.element = "string" == typeof (i = e) ? A(i) : i, this.timeouts = [], this.cursorPosition = 0, this.unfreeze = () => {
            }, this.predictedCursorPosition = null, this.statuses = E({}, r), this.id = Math.random().toString().substring(2, 9), this.queue = function (e) {
                let s = function (e) {
                    return t(e).forEach((e => n.set(Symbol(e.char?.innerText), i({...e})))), this
                }, i = e => (e.shouldPauseCursor = function () {
                    return Boolean(this.typeable || this.cursorable || this.deletable)
                }, e), r = () => Array.from(n.values()), n = new Map;
                return s(e), {
                    add: s,
                    set: function (e, t) {
                        let s = [...n.keys()];
            ...
            }([{delay: this.opts.startDelay}]), this.#e(s), this.cursor = this.#t(), this.element.dataset.typeitId = this.id, l(o), this.opts.strings.length && this.#s()
        }
        ...
        go() {
            ...
            }), {threshold: 1}).observe(e), this) : (this.#r(), this));
            var e, t
        }
        ...
        type(e, t = {}) {
            e = N(e);
            let {instant: s} = t, i = this.#a(t), r = g(e, this.opts.html).map((e => {
                    return {
                        func: () => this.#u(e),
                        char: e,
                ...
                n = [i[0], {func: async () => await this.opts.beforeString(e, this)}, ...r, {func: async () => await this.opts.afterString(e, this)}, i[1]];
            return this.#h(n, t)
        }
        ...
        move(e, t = {}) {
            e = N(e);
            let s = this.#a(t), {instant: i, to: r} = t, n = P({
        ...
        pause(e, t = {}) {
            return this.#h({delay: N(e)}, t)
        }

        delete(e = null, t = {}) {
            e = N(e);
            let s = this.#a(t), i = e, {instant: r, to: n} = t, o = this.queue.getTypeable(),
        ...
        async #i() {
            if (!this.#o() && this.cursor && this.element.appendChild(this.cursor), this.#C) {
                ((e, t) => {
                    let r = `[${s}='${e}'] .${i}`, n = getComputedStyle(t),
                ...
                let {animation: e} = this.opts.cursor, {frames: t, options: r} = e;
                w({frames: t, cursor: this.cursor, options: {duration: this.opts.cursorSpeed, ...r}})
            }
        }
        ...
        #s() {
            ...
            e.forEach(((t, s) => {
                ...
                let i = this.opts.breakLines ? [{
                    func: () => this.#u(a("BR")),
                    typeable: !0
                }] : C({func: this.#m.bind(this), delay: this.#l(1)}, this.queue.getTypeable().length);
                this.#T(i)
            }))
        }
        ...
        #e = e => {
            e.cursor = (e => {
                if ("object" == typeof e) {
                    let t = {}, {frames: s, options: i} = n.cursor.animation;
